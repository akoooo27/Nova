...
namespace Chat.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260603172101_ModelCatalog")]
            ...
            modelBuilder.Entity("Chat.Domain.ModelCatalog.Entities.LlmModel", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_llm_model");

                    b.HasIndex("ProviderId", "ExternalModelId")
                        .IsUnique()
                        .HasDatabaseName("ix_llm_model_provider_id_external_model_id");

                    b.HasIndex("ProviderId", "SortOrder")
                        .HasDatabaseName("ix_llm_model_provider_id_sort_order");

                    b.ToTable("llm_model", (string)null);
                });
            ...
            modelBuilder.Entity("Chat.Domain.ModelCatalog.LlmProvider", b =>
                {
                    ...
                    b.HasIndex("SortOrder", "Name")
                        .HasDatabaseName("ix_llm_providers_sort_order_name");
            ...
            modelBuilder.Entity("Chat.Domain.ModelCatalog.Entities.LlmModel", b =>
                {
                    b.HasOne("Chat.Domain.ModelCatalog.LlmProvider", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_llm_model_llm_providers_provider_id");
                });
