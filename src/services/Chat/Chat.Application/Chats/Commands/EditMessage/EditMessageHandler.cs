...
{
    public async ValueTask<ErrorOr<TurnStartedResult>> Handle(EditMessageCommand command, CancellationToken cancellationToken)
    {
        ...
        ErrorOr<ChatMessage> editResult = thread.EditUserMessage
        (
            messageId: messageId,
            content: content,
            createdAt: now
        ...
        ChatMessageId editedMessageId = editResult.Value.Id;
